...
//
//     final getSubCompanyCityModel = getSubCompanyCityModelFromJson(jsonString);

import 'dart:convert';

GetSubCompanyCityModel getSubCompanyCityModelFromJson(String str) => GetSubCompanyCityModel.fromJson(json.decode(str));

String getSubCompanyCityModelToJson(GetSubCompanyCityModel data) => json.encode(data.toJson());

class GetSubCompanyCityModel {
    GetSubCompanyCityModel({
        this.remitterTypeId,
        this.modeId,
        this.countryId,
        this.currencyId,
    ...
    dynamic currencies;
    List<String>? subcompaniesCities;
    dynamic bankCities;
    ...
    factory GetSubCompanyCityModel.fromJson(Map<String, dynamic> json) => GetSubCompanyCityModel(
        ...
        rate: json["rate"],
        operationDate: json["operationDate"] != null ? DateTime.parse(json["operationDate"]) : null,
        amount: json["amount"],
        ...
        subcompaniesCities: json["subcompaniesCities"] != null ? List<String>.from(json["subcompaniesCities"].map((x) => x)) : [],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "subcompaniesCities": List<dynamic>.from(subcompaniesCities!.map((x) => x)),
