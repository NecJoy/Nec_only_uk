...
//
//     final bankCitiesModel = bankCitiesModelFromJson(jsonString);

import 'dart:convert';

BankCitiesModel bankCitiesModelFromJson(String str) => BankCitiesModel.fromJson(json.decode(str));

String bankCitiesModelToJson(BankCitiesModel data) => json.encode(data.toJson());

class BankCitiesModel {
    BankCitiesModel({
        this.remitterTypeId,
        this.modeId,
        this.countryId,
    ...
    factory BankCitiesModel.fromJson(Map<String, dynamic> json) => BankCitiesModel(
        ...
        bankCities: List<String>.from(json["bankCities"].map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "bankCities": List<dynamic>.from(bankCities!.map((x) => x)),
