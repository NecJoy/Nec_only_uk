...
//
//     final getCustomerCommissionModel = getCustomerCommissionModelFromJson(jsonString);

import 'dart:convert';

GetCustomerCommissionModel getCustomerCommissionModelFromJson(String str) => GetCustomerCommissionModel.fromJson(json.decode(str));
String getCustomerCommissionModelToJson(GetCustomerCommissionModel data) => json.encode(data.toJson());

class GetCustomerCommissionModel {
    GetCustomerCommissionModel({
        this.remitterTypeId,
        this.modeId,
        this.countryId,
        this.currencyId,
    ...
    factory GetCustomerCommissionModel.fromJson(Map<String, dynamic> json) => GetCustomerCommissionModel(
